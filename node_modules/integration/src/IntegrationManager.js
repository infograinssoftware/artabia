...
class IntegrationManager {
  ...
  async _useChainId(provider, chainId) {
    ...
    console.log('11111111111111111111111111111111111', chainId, provider)
  ...
  async connect(chain, providedWeb3, providedAccount) {
    ...
    if(!web3) {
      ...
      console.log(provider, 'provider inside contract')
      if(isNormalHexInteger(chain)) {
        console.log(provider, 'chain 1 inside contract')
        await this._useChainId(provider, chain)
      } else {
        console.log(provider, 'chain 2 inside contract')
