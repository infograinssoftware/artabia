...
var ERROR_WEB3_MISSING = 'Missing web3 instance, make sure to call Moralis.enable()';
                      ...
                      while (1) {
                        switch (_context6.prev = _context6.next) {
                          ...
                          case 3:
                            ...
                            error = JSON.stringify(JSON.parse(response.data.data), null, 2);
      ...
      return _regenerator.default.async(function (_context12) {
        while (1) {
          switch (_context12.prev = _context12.next) {
            case 0:
              _ref8 = _args12.length > 0 && _args12[0] !== undefined ? _args12[0] : {}, contractAddress = _ref8.contractAddress, abi = _ref8.abi, functionName = _ref8.functionName, _ref8$params = _ref8.params, params = _ref8$params === void 0 ? {} : _ref8$params;
              _context12.next = 3;
              return _regenerator.default.awrap(MoralisWeb3.enable());

            case 3:
              web3 = _context12.sent;
              contractOptions = {};
            ...
            case 35:
              _context12.next = 37;
              return _regenerator.default.awrap(customFunction.apply(void 0, (0, _toConsumableArray2.default)(Object.values(parsedInputs))).send());
